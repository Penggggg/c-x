<template>
    <transition name="fade-c-filter-modal" v-if="show">
        <div class="c-my-filter-modal">
 ...
 * 用法：<my-filter-modal :show.sync="theShow" title="sad" >xxxx</my-filter-modal>
 * 特性一：允许嵌套使用
...
export default class MyDrawer extends Vue {
    ...
    /** 点击背景层 可以关闭弹窗 */
    @Prop({ type: Boolean, default: true }) bgclose!: boolean

    /** ls存储的前缀 */
    private readonly pre = 'hzpFilterModal';
