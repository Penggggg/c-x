...
var user = { "username": "何卓鹏", "user_id": 106, "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJSQU5ET00iOiI0OTA1NTciLCJjcmVhdGVfdGltZSI6MTU4NTE5NTg1NCwiZXhwIjoxNTg1MjgyMjU0LCJzc29fcm9sZSI6MCwidXNlcl9pZCI6MTA2fQ.zUUVEXewc73vXyabQKldzn9Fcv7obqr7o_NH_FzQ024", "login_name": "hezhuopeng", "role": { "role_name": "普通用户", "role_identify": 0, "from": "", "is_new": false }, "team": { "id": 2, "team_name": "engineer", "description": "工程组" } };
var a = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log('????');
                return [4 /*yield*/, aiJwt_1.AiJwt.sign(user)];
            case 1:
                b = _a.sent();
                console.log(b);
                return [2 /*return*/];
